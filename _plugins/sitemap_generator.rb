...
module Jekyll
  ...
  MY_URL = "http://kaleidofest.ca"

  # Change SITEMAP_FILE_NAME if you would like your sitemap file
  # to be called something else
  SITEMAP_FILE_NAME = "sitemap.xml"

  # Where should the sitemap file be created?
  # leave blank (empty string) to fallback to Jekyll build directory (site.dest)
  # "." (current directory) should place it at the root of the site and Jekyll will copy it into the build directory during generation.
  # "." is useful for sites using Github Pages for hosting
  SITEMAP_DIRECTORY = "."
  ...
  class SitemapGenerator < Generator
    ...
    def generate(site)
      ...
      # Get directory where sitemap.xml file will be written
      # destination = site.config['sitemap']['directory'] if site.config['sitemap']
      destination = SITEMAP_DIRECTORY if !SITEMAP_DIRECTORY.empty?
      ...
      file = File.new(File.join(destination, filename), "w")
      ...
      site.static_files << Jekyll::SitemapFile.new(site, destination, "/", filename)
    end
